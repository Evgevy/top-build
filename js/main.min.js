...
function openSubmenuHandler() {
  var dropdownLinks = document.querySelectorAll(".main-nav__link.main-nav__link--accent");
  dropdownLinks.forEach(function (dropdownLink) {
    var categoryButton = dropdownLink.closest("li");
    var categoryMenu = dropdownLink.nextElementSibling;
